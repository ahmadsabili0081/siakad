            ...
            <div class="col-md-6">
              ...
              <div class="form-group">
                ...
                <div class="col mx-0 my-2 px-0">
                  <img class="img-thumbnail mx-0 displayedImages" style="width: 100px; height:100px;" src="<?= $get_data['gambar'] ? base_url('gambar/fotoCalonSiswa/' . $get_data['gambar']) : base_url('gambar/fotoCalonSiswa/default.png'); ?>">
                </div>
