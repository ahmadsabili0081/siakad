...
<section class="section">
  ...
  <div class="row">
    <div class="col p-0">
      ...
      <div class="card">
        <div class="card-body">
          <a class="btn btn-sm btn-primary mb-4" href="<?= base_url('/guru/add_student'); ?>">Tambah Siswa</a>
                ...
                <?php foreach ($data as $siswa) :  ?>
                  <tr>
                    ...
                    <td class="text-center" style="width: 150px;">
                      <a class="btn btn-sm btn-warning btnEdit" href="<?= base_url('guru/edit_student/' . $siswa['no_pendaftaran']); ?>" title="Ubah Siswa"><i class="fas fa-edit"></i></a>
                      <a class="btn btn-sm btn-danger btnDelete" href="<?= base_url('guru/delete_student/' . $siswa['no_pendaftaran']); ?>" title="Hapus Siswa"><i class="fas fa-trash"></i></a>
                    </td>
                  </tr>
                <?php endforeach; ?>
              </tbody>
